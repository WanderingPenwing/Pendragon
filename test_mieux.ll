...
@texte_global-0 = private unnamed_addr constant [8 x i8] c"test : \00"
@texte_global-1 = private unnamed_addr constant [10 x i8] c"---------\00"
...
%expression_nombre-0-1 = add i64 6, 0
%expression_nombre-0-2 = add i64 3, 0
%expression_nombre-0-3 = add i64 %expression_nombre-0-1, %expression_nombre-0-2
%expression_nombre-0-fin = add i64 %expression_nombre-0-3, 0
...
%expression_nombre-1-1 = add i64 12, 0
%expression_nombre-1-2 = add i64 13, 0
%expression_nombre-1-3 = add i64 %expression_nombre-1-1, %expression_nombre-1-2
%expression_nombre-1-4 = add i64 4, 0
%expression_nombre-1-5 = add i64 %expression_nombre-1-3, %expression_nombre-1-4
%expression_nombre-1-fin = add i64 %expression_nombre-1-5, 0
%expression_texte-1-1 = call i8* @texte_nombre(i64 %expression_nombre-1-fin)
...
%expression_nombre-2-1 = add i64 12, 0
%expression_nombre-2-2 = add i64 2, 0
%expression_nombre-2-3 = add i64 12, 0
%expression_nombre-2-4 = mul i64 %expression_nombre-2-2, %expression_nombre-2-3
%expression_nombre-2-5 = add i64 40, 0
%expression_nombre-2-6 = add i64 77, 0
%expression_nombre-2-7 = add i64 %expression_nombre-2-5, %expression_nombre-2-6
%expression_nombre-2-8 = mul i64 %expression_nombre-2-6, %expression_nombre-2-7
%expression_nombre-2-9 = add i64 %expression_nombre-2-7, %expression_nombre-2-8
%expression_nombre-2-fin = add i64 %expression_nombre-2-9, 0
%expression_texte-2-1 = call i8* @texte_nombre(i64 %expression_nombre-2-fin)
...
call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %nouvelle_ligne)
%Patate-0 = add i64 0, 0
%Cornichon-0 = add i64 0, 0
%Test-0 = add i1 0, 0
%expression_texte-3-0 = getelementptr [1 x i8], [1 x i8]* @vide, i32 0, i32 0
%texte_global-0-str = getelementptr [8 x i8], [8 x i8]* @texte_global-0, i32 0, i32 0
%expression_texte-3-1 = call i8* @concat_strings(i8* %expression_texte-3-0, i8* %texte_global-0-str)
%expression_booleen-0-1 = add i1 %Test-0, 0
%expression_booleen-0-fin = add i1 %expression_booleen-0-1, 0
%expression_texte-3-2 = call i8* @texte_booleen(i1 %expression_booleen-0-fin)
%expression_texte-3-3 = call i8* @concat_strings(i8* %expression_texte-3-1, i8* %expression_texte-3-2)
%expression_texte-3-fin = getelementptr i8, i8* %expression_texte-3-3, i32 0
call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %expression_texte-3-fin)
call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %nouvelle_ligne)
%expression_texte-4-0 = getelementptr [1 x i8], [1 x i8]* @vide, i32 0, i32 0
%texte_global-1-str = getelementptr [10 x i8], [10 x i8]* @texte_global-1, i32 0, i32 0
%expression_texte-4-1 = call i8* @concat_strings(i8* %expression_texte-4-0, i8* %texte_global-1-str)
%expression_texte-4-fin = getelementptr i8, i8* %expression_texte-4-1, i32 0
call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %expression_texte-4-fin)
call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %nouvelle_ligne)
%expression_texte-5-0 = getelementptr [1 x i8], [1 x i8]* @vide, i32 0, i32 0
%expression_nombre-3-1 = add i64 2, 0
%expression_nombre-3-2 = add i64 %Patate-0, 0
%expression_nombre-3-3 = mul i64 %expression_nombre-3-1, %expression_nombre-3-2
%expression_nombre-3-4 = add i64 1, 0
%expression_nombre-3-5 = add i64 %Cornichon-0, 0
%expression_nombre-3-6 = mul i64 %expression_nombre-3-4, %expression_nombre-3-5
%expression_nombre-3-7 = add i64 %expression_nombre-3-5, %expression_nombre-3-6
%expression_nombre-3-8 = add i64 5, 0
%expression_nombre-3-9 = add i64 %expression_nombre-3-7, %expression_nombre-3-8
%expression_nombre-3-10 = add i64 12, 0
%expression_nombre-3-11 = add i64 %Cornichon-0, 0
%expression_nombre-3-12 = mul i64 %expression_nombre-3-10, %expression_nombre-3-11
%expression_nombre-3-13 = add i64 %expression_nombre-3-11, %expression_nombre-3-12
%expression_nombre-3-14 = add i64 3, 0
%expression_nombre-3-15 = add i64 %Patate-0, 0
%expression_nombre-3-16 = mul i64 %expression_nombre-3-14, %expression_nombre-3-15
%expression_nombre-3-17 = add i64 %expression_nombre-3-15, %expression_nombre-3-16
%expression_nombre-3-18 = add i64 1, 0
%expression_nombre-3-19 = sub i64 %expression_nombre-3-17, %expression_nombre-3-18
%expression_nombre-3-fin = add i64 %expression_nombre-3-19, 0
%expression_texte-5-1 = call i8* @texte_nombre(i64 %expression_nombre-3-fin)
...
%expression_nombre-4-1 = add i64 12, 0
%expression_nombre-4-2 = add i64 0, 0
%expression_nombre-4-3 = sdiv i64 %expression_nombre-4-1, %expression_nombre-4-2
%expression_nombre-4-fin = add i64 %expression_nombre-4-3, 0
%expression_texte-6-1 = call i8* @texte_nombre(i64 %expression_nombre-4-fin)
...
call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %nouvelle_ligne)
%expression_nombre-5-1 = add i64 1, 0
%expression_nombre-5-2 = add i64 2, 0
%expression_nombre-5-3 = add i64 %expression_nombre-5-1, %expression_nombre-5-2
%expression_nombre-5-4 = add i64 3, 0
%expression_nombre-5-5 = add i64 14, 0
%expression_nombre-5-6 = mul i64 %expression_nombre-5-4, %expression_nombre-5-5
%expression_nombre-5-7 = add i64 %expression_nombre-5-5, %expression_nombre-5-6
%expression_nombre-5-8 = add i64 6, 0
%expression_nombre-5-9 = add i64 %expression_nombre-5-7, %expression_nombre-5-8
%expression_nombre-5-10 = add i64 2, 0
%expression_nombre-5-11 = sub i64 %expression_nombre-5-9, %expression_nombre-5-10
%expression_nombre-5-12 = add i64 2, 0
%expression_nombre-5-13 = sub i64 %expression_nombre-5-11, %expression_nombre-5-12
%expression_nombre-5-14 = add i64 4, 0
%expression_nombre-5-15 = add i64 8, 0
%expression_nombre-5-16 = mul i64 %expression_nombre-5-14, %expression_nombre-5-15
%expression_nombre-5-17 = add i64 %expression_nombre-5-15, %expression_nombre-5-16
%expression_nombre-5-18 = add i64 1, 0
%expression_nombre-5-19 = sub i64 %expression_nombre-5-17, %expression_nombre-5-18
%expression_nombre-5-20 = add i64 40, 0
%expression_nombre-5-21 = add i64 3, 0
%expression_nombre-5-22 = mul i64 %expression_nombre-5-20, %expression_nombre-5-21
%expression_nombre-5-23 = add i64 3, 0
%expression_nombre-5-24 = mul i64 %expression_nombre-5-22, %expression_nombre-5-23
%expression_nombre-5-25 = add i64 %expression_nombre-5-23, %expression_nombre-5-24
%expression_nombre-5-26 = add i64 50, 0
%expression_nombre-5-27 = sub i64 %expression_nombre-5-25, %expression_nombre-5-26
%expression_nombre-5-28 = add i64 0, 0
%expression_nombre-5-29 = mul i64 %expression_nombre-5-27, %expression_nombre-5-28
%expression_nombre-5-30 = add i64 1, 0
%expression_nombre-5-31 = add i64 %expression_nombre-5-29, %expression_nombre-5-30
%expression_nombre-5-fin = add i64 %expression_nombre-5-31, 0
%Patate-1 = add i64 %expression_nombre-5-fin, 0
%expression_texte-7-0 = getelementptr [1 x i8], [1 x i8]* @vide, i32 0, i32 0
%expression_nombre-6-1 = add i64 %Patate-1, 0
%expression_nombre-6-fin = add i64 %expression_nombre-6-1, 0
%expression_texte-7-1 = call i8* @texte_nombre(i64 %expression_nombre-6-fin)
%expression_texte-7-2 = call i8* @concat_strings(i8* %expression_texte-7-0, i8* %expression_texte-7-1)
%expression_texte-7-fin = getelementptr i8, i8* %expression_texte-7-2, i32 0
call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %expression_texte-7-fin)
call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %nouvelle_ligne)
