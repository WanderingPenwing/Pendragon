...
@texte_global-0 = private unnamed_addr constant [14 x i8] c"Allumettes : \00"
@texte_global-1 = private unnamed_addr constant [7 x i8] c"=====o\00"

define { i64 } @bloc-1( i64 %Nombre-1) {
entry:
	%fmt_ptr = getelementptr [3 x i8], [3 x i8]* @format_str, i32 0, i32 0
	%nouvelle_ligne = getelementptr [2 x i8], [2 x i8]* @newline, i32 0, i32 0
	%expression_nombre-4-1 = add i64 %Nombre-1, 0
	%expression_nombre-4-fin = add i64 %expression_nombre-4-1, 0
	%expression_nombre-5-1 = add i64 0, 0
	%expression_nombre-5-fin = add i64 %expression_nombre-5-1, 0
	%comparaison-1 = icmp sgt i64 %expression_nombre-4-fin, %expression_nombre-5-fin
	%expression_booleen-1-1 = add i1 %comparaison-1, 0
	%expression_booleen-1-fin = add i1 %expression_booleen-1-1, 0
	br i1 %expression_booleen-1-fin, label %continue, label %stop
stop:
	%result-0-0 = insertvalue { i64 } undef, i64 %Nombre-1, 0
	ret { i64 } %result-0-0
continue:
	%expression_texte-1-0 = getelementptr [1 x i8], [1 x i8]* @vide, i32 0, i32 0
	%texte_global-1-str = getelementptr [7 x i8], [7 x i8]* @texte_global-1, i32 0, i32 0
	%expression_texte-1-1 = call i8* @concat_strings(i8* %expression_texte-1-0, i8* %texte_global-1-str)
	%expression_texte-1-fin = getelementptr i8, i8* %expression_texte-1-1, i32 0
	...
	%expression_nombre-6-2 = add i64 1, 0
	%expression_nombre-6-3 = sub i64 %expression_nombre-6-1, %expression_nombre-6-2
	%expression_nombre-6-fin = add i64 %expression_nombre-6-3, 0
	%Nombre-2 = add i64 %expression_nombre-6-fin, 0
	%result-fin = call { i64 } @bloc-1( i64 %Nombre-2)
	 ret { i64 } %result-fin
}

@texte_global-2 = private unnamed_addr constant [39 x i8] c"Choisissez un nombre entre un et trois\00"
@Enleve-1-nom = private unnamed_addr constant [7 x i8] c"Enleve\00"

define { i64 } @bloc-2( i64 %Enleve-0) {
entry:
	%fmt_ptr = getelementptr [3 x i8], [3 x i8]* @format_str, i32 0, i32 0
	%nouvelle_ligne = getelementptr [2 x i8], [2 x i8]* @newline, i32 0, i32 0
	%expression_nombre-7-1 = add i64 %Enleve-0, 0
	%expression_nombre-7-fin = add i64 %expression_nombre-7-1, 0
	%expression_nombre-8-1 = add i64 1, 0
	%expression_nombre-8-fin = add i64 %expression_nombre-8-1, 0
	%comparaison-2 = icmp slt i64 %expression_nombre-7-fin, %expression_nombre-8-fin
	%expression_booleen-2-1 = add i1 %comparaison-2, 0
	%expression_nombre-9-1 = add i64 %Enleve-0, 0
	%expression_nombre-9-fin = add i64 %expression_nombre-9-1, 0
	%expression_nombre-10-1 = add i64 3, 0
	%expression_nombre-10-fin = add i64 %expression_nombre-10-1, 0
	%comparaison-3 = icmp sgt i64 %expression_nombre-9-fin, %expression_nombre-10-fin
	%expression_booleen-2-2 = add i1 %comparaison-3, 0
	%expression_booleen-2-3 = or i1 %expression_booleen-2-1, %expression_booleen-2-2
	%expression_booleen-2-fin = add i1 %expression_booleen-2-3, 0
	br i1 %expression_booleen-2-fin, label %continue, label %stop
stop:
	%result-0-0 = insertvalue { i64 } undef, i64 %Enleve-0, 0
	ret { i64 } %result-0-0
continue:
	%expression_texte-2-0 = getelementptr [1 x i8], [1 x i8]* @vide, i32 0, i32 0
	%texte_global-2-str = getelementptr [39 x i8], [39 x i8]* @texte_global-2, i32 0, i32 0
	...
	call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %nouvelle_ligne)
	%Enleve-1-nom = getelementptr [7 x i8], [7 x i8]* @Enleve-1-nom, i32 0, i32 0
	%Enleve-1 = call i64 @demande_entier(i8* %Enleve-1-nom)
	%result-fin = call { i64 } @bloc-2( i64 %Enleve-1)
	 ret { i64 } %result-fin
}

@texte_global-3 = private unnamed_addr constant [13 x i8] c"------------\00"

define { i64 } @bloc-0( i64 %Allumettes-1) {
entry:
	%fmt_ptr = getelementptr [3 x i8], [3 x i8]* @format_str, i32 0, i32 0
	%nouvelle_ligne = getelementptr [2 x i8], [2 x i8]* @newline, i32 0, i32 0
	%expression_nombre-1-1 = add i64 %Allumettes-1, 0
	...
	%comparaison-0 = icmp sgt i64 %expression_nombre-1-fin, %expression_nombre-2-fin
...
stop:
	%result-0-0 = insertvalue { i64 } undef, i64 %Allumettes-1, 0
	ret { i64 } %result-0-0
continue:
	%expression_texte-0-0 = getelementptr [1 x i8], [1 x i8]* @vide, i32 0, i32 0
	%texte_global-0-str = getelementptr [14 x i8], [14 x i8]* @texte_global-0, i32 0, i32 0
	%expression_texte-0-1 = call i8* @concat_strings(i8* %expression_texte-0-0, i8* %texte_global-0-str)
	%expression_texte-0-fin = getelementptr i8, i8* %expression_texte-0-1, i32 0
	call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %expression_texte-0-fin)
	call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %nouvelle_ligne)
	%Nombre-0 = add i64 0, 0
	%expression_nombre-3-1 = add i64 %Allumettes-1, 0
	%expression_nombre-3-fin = add i64 %expression_nombre-3-1, 0
	%Nombre-1 = add i64 %expression_nombre-3-fin, 0
	%result-bloc-1 = call { i64 } @bloc-1( i64 %Nombre-1)
	%Nombre-3 = extractvalue { i64 } %result-bloc-1, 0
	%Enleve-0 = add i64 0, 0
	%result-bloc-2 = call { i64 } @bloc-2( i64 %Enleve-0)
	%Enleve-2 = extractvalue { i64 } %result-bloc-2, 0
	%expression_nombre-11-1 = add i64 %Allumettes-1, 0
	%expression_nombre-11-2 = add i64 %Enleve-2, 0
	%expression_nombre-11-3 = sub i64 %expression_nombre-11-1, %expression_nombre-11-2
	%expression_nombre-11-fin = add i64 %expression_nombre-11-3, 0
	%Allumettes-2 = add i64 %expression_nombre-11-fin, 0
	%expression_texte-3-0 = getelementptr [1 x i8], [1 x i8]* @vide, i32 0, i32 0
	%texte_global-3-str = getelementptr [13 x i8], [13 x i8]* @texte_global-3, i32 0, i32 0
	...
	call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %nouvelle_ligne)
	%result-fin = call { i64 } @bloc-0( i64 %Allumettes-2)
	 ret { i64 } %result-fin
}

@texte_global-4 = private unnamed_addr constant [14 x i8] c"Allumettes : \00"
@texte_global-5 = private unnamed_addr constant [7 x i8] c"=====o\00"
@texte_global-6 = private unnamed_addr constant [31 x i8] c"Joueur suivant : Tu as perdu !\00"

define i32 @main() {
	%fmt_ptr = getelementptr [3 x i8], [3 x i8]* @format_str, i32 0, i32 0
	%nouvelle_ligne = getelementptr [2 x i8], [2 x i8]* @newline, i32 0, i32 0
	%Allumettes-0 = add i64 0, 0
	%expression_nombre-0-1 = add i64 15, 0
	%expression_nombre-0-fin = add i64 %expression_nombre-0-1, 0
	%Allumettes-1 = add i64 %expression_nombre-0-fin, 0
	%result-bloc-0 = call { i64 } @bloc-0( i64 %Allumettes-1)
	%Allumettes-3 = extractvalue { i64 } %result-bloc-0, 0
	%expression_texte-4-0 = getelementptr [1 x i8], [1 x i8]* @vide, i32 0, i32 0
	%texte_global-4-str = getelementptr [14 x i8], [14 x i8]* @texte_global-4, i32 0, i32 0
	%expression_texte-4-1 = call i8* @concat_strings(i8* %expression_texte-4-0, i8* %texte_global-4-str)
	...
	%texte_global-5-str = getelementptr [7 x i8], [7 x i8]* @texte_global-5, i32 0, i32 0
	%expression_texte-5-1 = call i8* @concat_strings(i8* %expression_texte-5-0, i8* %texte_global-5-str)
	%expression_texte-5-fin = getelementptr i8, i8* %expression_texte-5-1, i32 0
	call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %expression_texte-5-fin)
	call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %nouvelle_ligne)
	%expression_texte-6-0 = getelementptr [1 x i8], [1 x i8]* @vide, i32 0, i32 0
	%texte_global-6-str = getelementptr [31 x i8], [31 x i8]* @texte_global-6, i32 0, i32 0
	%expression_texte-6-1 = call i8* @concat_strings(i8* %expression_texte-6-0, i8* %texte_global-6-str)
	%expression_texte-6-fin = getelementptr i8, i8* %expression_texte-6-1, i32 0
