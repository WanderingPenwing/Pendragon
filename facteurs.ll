...
@Nombre-1-nom = private unnamed_addr constant [7 x i8] c"Nombre\00"

define { i64, i64, i64 } @bloc-1( i64 %Index-1, i64 %Nombre-1, i64 %Diviseur-1) {
entry:
	%fmt_ptr = getelementptr [3 x i8], [3 x i8]* @format_str, i32 0, i32 0
	%nouvelle_ligne = getelementptr [2 x i8], [2 x i8]* @newline, i32 0, i32 0
	%expression_nombre-4-1 = add i64 %Index-1, 0
	%expression_nombre-4-2 = add i64 %Index-1, 0
	%expression_nombre-4-3 = mul i64 %expression_nombre-4-1, %expression_nombre-4-2
	%expression_nombre-4-fin = add i64 %expression_nombre-4-3, 0
	%expression_nombre-5-1 = add i64 %Nombre-1, 0
	%expression_nombre-5-fin = add i64 %expression_nombre-5-1, 0
	%comparaison-1 = icmp sle i64 %expression_nombre-4-fin, %expression_nombre-5-fin
	%expression_booleen-1-1 = add i1 %comparaison-1, 0
	%expression_nombre-6-1 = add i64 %Nombre-1, 0
	%expression_nombre-6-2 = add i64 %Diviseur-1, 0
	%expression_nombre-6-3 = add i64 %Index-1, 0
	%expression_nombre-6-4 = mul i64 %expression_nombre-6-2, %expression_nombre-6-3
	%expression_nombre-6-5 = sub i64 %expression_nombre-6-1, %expression_nombre-6-4
	%expression_nombre-6-fin = add i64 %expression_nombre-6-5, 0
	%expression_nombre-7-1 = add i64 0, 0
	%expression_nombre-7-fin = add i64 %expression_nombre-7-1, 0
	%comparaison-2 = icmp ne i64 %expression_nombre-6-fin, %expression_nombre-7-fin
	%expression_booleen-1-2 = add i1 %comparaison-2, 0
	%expression_booleen-1-3 = and i1 %expression_booleen-1-1, %expression_booleen-1-2
	%expression_booleen-1-fin = add i1 %expression_booleen-1-3, 0
	br i1 %expression_booleen-1-fin, label %continue, label %stop
stop:
	%result-0-0 = insertvalue { i64, i64, i64 } undef, i64 %Index-1, 0
	%result-0-1 = insertvalue { i64, i64, i64 } %result-0-0, i64 %Nombre-1, 1
	%result-0-2 = insertvalue { i64, i64, i64 } %result-0-1, i64 %Diviseur-1, 2
	ret { i64, i64, i64 } %result-0-2
continue:
	%expression_nombre-8-1 = add i64 %Index-1, 0
	%expression_nombre-8-2 = add i64 1, 0
	%expression_nombre-8-3 = add i64 %expression_nombre-8-1, %expression_nombre-8-2
	%expression_nombre-8-fin = add i64 %expression_nombre-8-3, 0
	%Index-2 = add i64 %expression_nombre-8-fin, 0
	%expression_nombre-9-1 = add i64 %Nombre-1, 0
	%expression_nombre-9-2 = add i64 %Index-2, 0
	%expression_nombre-9-3 = sdiv i64 %expression_nombre-9-1, %expression_nombre-9-2
	%expression_nombre-9-fin = add i64 %expression_nombre-9-3, 0
	%Diviseur-2 = add i64 %expression_nombre-9-fin, 0
	%result-fin = call { i64, i64, i64 } @bloc-1( i64 %Index-2, i64 %Nombre-1, i64 %Diviseur-2)
	 ret { i64, i64, i64 } %result-fin
}


define { i64, i64 } @bloc-2( i64 %Index-4, i64 %Nombre-2) {
entry:
	%fmt_ptr = getelementptr [3 x i8], [3 x i8]* @format_str, i32 0, i32 0
	%nouvelle_ligne = getelementptr [2 x i8], [2 x i8]* @newline, i32 0, i32 0
	%expression_nombre-11-1 = add i64 %Index-4, 0
	%expression_nombre-11-2 = add i64 %Index-4, 0
	%expression_nombre-11-3 = mul i64 %expression_nombre-11-1, %expression_nombre-11-2
	%expression_nombre-11-fin = add i64 %expression_nombre-11-3, 0
	%expression_nombre-12-1 = add i64 %Nombre-2, 0
	%expression_nombre-12-fin = add i64 %expression_nombre-12-1, 0
	%comparaison-3 = icmp sgt i64 %expression_nombre-11-fin, %expression_nombre-12-fin
	%expression_booleen-2-1 = add i1 %comparaison-3, 0
	%expression_booleen-2-fin = add i1 %expression_booleen-2-1, 0
	br i1 %expression_booleen-2-fin, label %continue, label %stop
stop:
	%result-0-0 = insertvalue { i64, i64 } undef, i64 %Index-4, 0
	%result-0-1 = insertvalue { i64, i64 } %result-0-0, i64 %Nombre-2, 1
	ret { i64, i64 } %result-0-1
continue:
	%expression_texte-0-0 = getelementptr [1 x i8], [1 x i8]* @vide, i32 0, i32 0
	%expression_nombre-13-1 = add i64 %Nombre-2, 0
	%expression_nombre-13-fin = add i64 %expression_nombre-13-1, 0
	%expression_texte-0-1 = call i8* @texte_nombre(i64 %expression_nombre-13-fin)
	%expression_texte-0-2 = call i8* @concat_strings(i8* %expression_texte-0-0, i8* %expression_texte-0-1)
	%expression_texte-0-fin = getelementptr i8, i8* %expression_texte-0-2, i32 0
	call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %expression_texte-0-fin)
	call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %nouvelle_ligne)
	%expression_nombre-14-1 = add i64 1, 0
	%expression_nombre-14-fin = add i64 %expression_nombre-14-1, 0
	%Nombre-3 = add i64 %expression_nombre-14-fin, 0
	%result-1-0 = insertvalue { i64, i64 } undef, i64 %Index-4, 0
	%result-1-1 = insertvalue { i64, i64 } %result-1-0, i64 %Nombre-3, 1
	ret { i64, i64 } %result-1-1
}


define { i64, i64, i64 } @bloc-3( i64 %Index-6, i64 %Nombre-4, i64 %Diviseur-3) {
entry:
	%fmt_ptr = getelementptr [3 x i8], [3 x i8]* @format_str, i32 0, i32 0
	%nouvelle_ligne = getelementptr [2 x i8], [2 x i8]* @newline, i32 0, i32 0
	%expression_nombre-16-1 = add i64 %Index-6, 0
	%expression_nombre-16-2 = add i64 %Index-6, 0
	%expression_nombre-16-3 = mul i64 %expression_nombre-16-1, %expression_nombre-16-2
	%expression_nombre-16-fin = add i64 %expression_nombre-16-3, 0
	%expression_nombre-17-1 = add i64 %Nombre-4, 0
	%expression_nombre-17-fin = add i64 %expression_nombre-17-1, 0
	%comparaison-4 = icmp sle i64 %expression_nombre-16-fin, %expression_nombre-17-fin
	%expression_booleen-3-1 = add i1 %comparaison-4, 0
	%expression_booleen-3-fin = add i1 %expression_booleen-3-1, 0
	br i1 %expression_booleen-3-fin, label %continue, label %stop
stop:
	%result-0-0 = insertvalue { i64, i64, i64 } undef, i64 %Index-6, 0
	%result-0-1 = insertvalue { i64, i64, i64 } %result-0-0, i64 %Nombre-4, 1
	%result-0-2 = insertvalue { i64, i64, i64 } %result-0-1, i64 %Diviseur-3, 2
	ret { i64, i64, i64 } %result-0-2
continue:
	%expression_texte-1-0 = getelementptr [1 x i8], [1 x i8]* @vide, i32 0, i32 0
	%expression_nombre-18-1 = add i64 %Index-6, 0
	%expression_nombre-18-fin = add i64 %expression_nombre-18-1, 0
	%expression_texte-1-1 = call i8* @texte_nombre(i64 %expression_nombre-18-fin)
	...
	call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %nouvelle_ligne)
	%expression_nombre-19-1 = add i64 %Diviseur-3, 0
	%expression_nombre-19-fin = add i64 %expression_nombre-19-1, 0
	%Nombre-5 = add i64 %expression_nombre-19-fin, 0
	%result-1-0 = insertvalue { i64, i64, i64 } undef, i64 %Index-6, 0
	%result-1-1 = insertvalue { i64, i64, i64 } %result-1-0, i64 %Nombre-5, 1
	%result-1-2 = insertvalue { i64, i64, i64 } %result-1-1, i64 %Diviseur-3, 2
	ret { i64, i64, i64 } %result-1-2
}

@texte_global-0 = private unnamed_addr constant [9 x i8] c"Index : \00"
@texte_global-1 = private unnamed_addr constant [15 x i8] c" | Diviseur : \00"
@texte_global-2 = private unnamed_addr constant [13 x i8] c" | Nombre : \00"

define { i64, i64 } @bloc-0( i64 %Nombre-1, i64 %Diviseur-0) {
entry:
	%fmt_ptr = getelementptr [3 x i8], [3 x i8]* @format_str, i32 0, i32 0
	%nouvelle_ligne = getelementptr [2 x i8], [2 x i8]* @newline, i32 0, i32 0
	%expression_nombre-0-1 = add i64 %Nombre-1, 0
	%expression_nombre-0-fin = add i64 %expression_nombre-0-1, 0
	%expression_nombre-1-1 = add i64 1, 0
	%expression_nombre-1-fin = add i64 %expression_nombre-1-1, 0
	%comparaison-0 = icmp sgt i64 %expression_nombre-0-fin, %expression_nombre-1-fin
	%expression_booleen-0-1 = add i1 %comparaison-0, 0
	%expression_booleen-0-fin = add i1 %expression_booleen-0-1, 0
	br i1 %expression_booleen-0-fin, label %continue, label %stop
stop:
	%result-0-0 = insertvalue { i64, i64 } undef, i64 %Nombre-1, 0
	%result-0-1 = insertvalue { i64, i64 } %result-0-0, i64 %Diviseur-0, 1
	ret { i64, i64 } %result-0-1
continue:
	%expression_nombre-2-1 = add i64 1, 0
	%expression_nombre-2-fin = add i64 %expression_nombre-2-1, 0
	%Diviseur-1 = add i64 %expression_nombre-2-fin, 0
	%Index-0 = add i64 0, 0
	%expression_nombre-3-1 = add i64 1, 0
	%expression_nombre-3-fin = add i64 %expression_nombre-3-1, 0
	%Index-1 = add i64 %expression_nombre-3-fin, 0
	%result-bloc-1 = call { i64, i64, i64 } @bloc-1( i64 %Index-1, i64 %Nombre-1, i64 %Diviseur-1)
	%Index-3 = extractvalue { i64, i64, i64 } %result-bloc-1, 0
	%Nombre-2 = extractvalue { i64, i64, i64 } %result-bloc-1, 1
	%Diviseur-3 = extractvalue { i64, i64, i64 } %result-bloc-1, 2
	%expression_nombre-10-1 = add i64 %Index-3, 0
	%expression_nombre-10-fin = add i64 %expression_nombre-10-1, 0
	%Index-4 = add i64 %expression_nombre-10-fin, 0
	%result-bloc-2 = call { i64, i64 } @bloc-2( i64 %Index-4, i64 %Nombre-2)
	%Index-5 = extractvalue { i64, i64 } %result-bloc-2, 0
	%Nombre-4 = extractvalue { i64, i64 } %result-bloc-2, 1
	%expression_nombre-15-1 = add i64 %Index-5, 0
	%expression_nombre-15-fin = add i64 %expression_nombre-15-1, 0
	%Index-6 = add i64 %expression_nombre-15-fin, 0
	%result-bloc-3 = call { i64, i64, i64 } @bloc-3( i64 %Index-6, i64 %Nombre-4, i64 %Diviseur-3)
	%Index-7 = extractvalue { i64, i64, i64 } %result-bloc-3, 0
	%Nombre-6 = extractvalue { i64, i64, i64 } %result-bloc-3, 1
	%Diviseur-4 = extractvalue { i64, i64, i64 } %result-bloc-3, 2
	%expression_texte-2-0 = getelementptr [1 x i8], [1 x i8]* @vide, i32 0, i32 0
	%texte_global-0-str = getelementptr [9 x i8], [9 x i8]* @texte_global-0, i32 0, i32 0
	%expression_texte-2-1 = call i8* @concat_strings(i8* %expression_texte-2-0, i8* %texte_global-0-str)
	%expression_nombre-20-1 = add i64 %Index-7, 0
	%expression_nombre-20-fin = add i64 %expression_nombre-20-1, 0
	%expression_texte-2-2 = call i8* @texte_nombre(i64 %expression_nombre-20-fin)
	%expression_texte-2-3 = call i8* @concat_strings(i8* %expression_texte-2-1, i8* %expression_texte-2-2)
	%texte_global-1-str = getelementptr [15 x i8], [15 x i8]* @texte_global-1, i32 0, i32 0
	%expression_texte-2-4 = call i8* @concat_strings(i8* %expression_texte-2-3, i8* %texte_global-1-str)
	%expression_nombre-21-1 = add i64 %Diviseur-4, 0
	%expression_nombre-21-fin = add i64 %expression_nombre-21-1, 0
	%expression_texte-2-5 = call i8* @texte_nombre(i64 %expression_nombre-21-fin)
	%expression_texte-2-6 = call i8* @concat_strings(i8* %expression_texte-2-4, i8* %expression_texte-2-5)
	%texte_global-2-str = getelementptr [13 x i8], [13 x i8]* @texte_global-2, i32 0, i32 0
	%expression_texte-2-7 = call i8* @concat_strings(i8* %expression_texte-2-6, i8* %texte_global-2-str)
	%expression_nombre-22-1 = add i64 %Nombre-6, 0
	%expression_nombre-22-fin = add i64 %expression_nombre-22-1, 0
	%expression_texte-2-8 = call i8* @texte_nombre(i64 %expression_nombre-22-fin)
	%expression_texte-2-9 = call i8* @concat_strings(i8* %expression_texte-2-7, i8* %expression_texte-2-8)
	%expression_texte-2-fin = getelementptr i8, i8* %expression_texte-2-9, i32 0
	call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %expression_texte-2-fin)
	call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %nouvelle_ligne)
	%expression_nombre-23-1 = add i64 %Index-7, 0
	%expression_nombre-23-fin = add i64 %expression_nombre-23-1, 0
	%Index-8 = add i64 %expression_nombre-23-fin, 0
	%result-fin = call { i64, i64 } @bloc-0( i64 %Nombre-6, i64 %Diviseur-4)
	 ret { i64, i64 } %result-fin
}

@texte_global-3 = private unnamed_addr constant [4 x i8] c"Fin\00"

define i32 @main() {
	%fmt_ptr = getelementptr [3 x i8], [3 x i8]* @format_str, i32 0, i32 0
	%nouvelle_ligne = getelementptr [2 x i8], [2 x i8]* @newline, i32 0, i32 0
	%Nombre-0 = add i64 0, 0
	%Diviseur-0 = add i64 0, 0
	%Nombre-1-nom = getelementptr [7 x i8], [7 x i8]* @Nombre-1-nom, i32 0, i32 0
	%Nombre-1 = call i64 @demande_entier(i8* %Nombre-1-nom)
	%result-bloc-0 = call { i64, i64 } @bloc-0( i64 %Nombre-1, i64 %Diviseur-0)
	%Nombre-7 = extractvalue { i64, i64 } %result-bloc-0, 0
	%Diviseur-5 = extractvalue { i64, i64 } %result-bloc-0, 1
	%expression_texte-3-0 = getelementptr [1 x i8], [1 x i8]* @vide, i32 0, i32 0
	%texte_global-3-str = getelementptr [4 x i8], [4 x i8]* @texte_global-3, i32 0, i32 0
	%expression_texte-3-1 = call i8* @concat_strings(i8* %expression_texte-3-0, i8* %texte_global-3-str)
	%expression_texte-3-fin = getelementptr i8, i8* %expression_texte-3-1, i32 0
