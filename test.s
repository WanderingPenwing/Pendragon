...
.Lfunc_end5:
	...
	.cfi_endproc
                                        # -- End function
	.globl	affiche_espace                  # -- Begin function affiche_espace
	.p2align	4, 0x90
	.type	affiche_espace,@function
affiche_espace:                         # @affiche_espace
	.cfi_startproc
# %bb.0:
	pushq	%rax
	.cfi_def_cfa_offset 16
	leaq	.Lespace(%rip), %rdi
	callq	printf@PLT
	popq	%rax
	.cfi_def_cfa_offset 8
	retq
.Lfunc_end6:
	.size	affiche_espace, .Lfunc_end6-affiche_espace
	.cfi_endproc
                                        # -- End function
...
.LBB7_1:                                # %zero
	...
	retq
.Lfunc_end7:
	.size	mille_puissance, .Lfunc_end7-mille_puissance
	.cfi_endproc
                                        # -- End function
...
.LBB8_2:                                # %recursion
	...
	retq
.Lfunc_end8:
	.size	log_mille, .Lfunc_end8-log_mille
	.cfi_endproc
                                        # -- End function
