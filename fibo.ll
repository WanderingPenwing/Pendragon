...
stop:
	%result-0-0 = insertvalue { i64, i64, i64 } undef, i64 %N-1, 0
	%result-0-1 = insertvalue { i64, i64, i64 } %result-0-0, i64 %A-0, 1
	%result-0-2 = insertvalue { i64, i64, i64 } %result-0-1, i64 %B-1, 2
	ret { i64, i64, i64 } %result-0-2
continue:
	%expression_nombre-4-1 = add i64 %N-1, 0
	%expression_nombre-4-2 = add i64 1, 0
	%expression_nombre-4-3 = sub i64 %expression_nombre-4-1, %expression_nombre-4-2
	%expression_nombre-4-fin = add i64 %expression_nombre-4-3, 0
	%N-2 = add i64 %expression_nombre-4-fin, 0
	%expression_texte-0-0 = getelementptr [1 x i8], [1 x i8]* @vide, i32 0, i32 0
	%expression_nombre-5-1 = add i64 %A-0, 0
	%expression_nombre-5-fin = add i64 %expression_nombre-5-1, 0
	%expression_texte-0-1 = call i8* @texte_nombre(i64 %expression_nombre-5-fin)
	...
	%expression_nombre-6-1 = add i64 %B-1, 0
	%expression_nombre-6-fin = add i64 %expression_nombre-6-1, 0
	%expression_texte-1-1 = call i8* @texte_nombre(i64 %expression_nombre-6-fin)
	...
	call i32 (i8*, ...) @printf(i8* %fmt_ptr, i8* %nouvelle_ligne)
	%expression_nombre-7-1 = add i64 %A-0, 0
	%expression_nombre-7-2 = add i64 %B-1, 0
	%expression_nombre-7-3 = add i64 %expression_nombre-7-1, %expression_nombre-7-2
	%expression_nombre-7-fin = add i64 %expression_nombre-7-3, 0
	%A-1 = add i64 %expression_nombre-7-fin, 0
	%expression_nombre-8-1 = add i64 %A-1, 0
	%expression_nombre-8-2 = add i64 %B-1, 0
	...
	%B-2 = add i64 %expression_nombre-8-fin, 0
	%result-fin = call { i64, i64, i64 } @bloc-0( i64 %N-2, i64 %A-1, i64 %B-2)
	 ret { i64, i64, i64 } %result-fin
}

@texte_global-0 = private unnamed_addr constant [4 x i8] c"Fin\00"
...
define i32 @main() {
	...
	%A-0 = add i64 0, 0
	%B-0 = add i64 0, 0
	%expression_nombre-0-1 = add i64 1, 0
	%expression_nombre-0-fin = add i64 %expression_nombre-0-1, 0
	%B-1 = add i64 %expression_nombre-0-fin, 0
	%N-0 = add i64 0, 0
	%expression_nombre-1-1 = add i64 17, 0
	%expression_nombre-1-fin = add i64 %expression_nombre-1-1, 0
	%N-1 = add i64 %expression_nombre-1-fin, 0
	%result-bloc-0 = call { i64, i64, i64 } @bloc-0( i64 %N-1, i64 %A-0, i64 %B-1)
	%N-3 = extractvalue { i64, i64, i64 } %result-bloc-0, 0
	%A-2 = extractvalue { i64, i64, i64 } %result-bloc-0, 1
	%B-3 = extractvalue { i64, i64, i64 } %result-bloc-0, 2
	%expression_texte-2-0 = getelementptr [1 x i8], [1 x i8]* @vide, i32 0, i32 0
	%texte_global-0-str = getelementptr [4 x i8], [4 x i8]* @texte_global-0, i32 0, i32 0
